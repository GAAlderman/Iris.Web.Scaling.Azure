...
namespace Iris.Web.Scaling.Azure.Controllers
{
    public class SmapiCommandHandlerControllerUtils
    {
        ...
        public static HttpClient CreateVMManagementClient(string thumbprint)
        {
            ...
            handler.ClientCertificates.Add(FetchX509Certificate(thumbprint));
        ...
        public static HttpResponseMessage IssueAzureCommand(string uri, string method, string thumbprint, string requestBodyXML = "")
        {
        ...
        private static X509Certificate2 ConstructX509Certificate(string cert, string certPassword)
        {
            return
